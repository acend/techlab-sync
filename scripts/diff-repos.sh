...
if (($# == 0)); then
  ...
  REPOS="acend/argocd-training acend/container-basics-training acend/helm-basics-training acend/kubernetes-basics-training acend/openshift-4-ops-training puzzle/amm-techlab puzzle/jenkins-techlab"
else
  REPOS=$1
fi
...
FILES="action config contributing dockerfile gitignore husky license markdownlint package renovate"
